  ...
  build_screen() {
    ...
    return !loaded_data
        ...
        : Container(
            ...
            child: widget.cal_sub_names.isEmpty
                ? Container(
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      if (widget.cal_sub_names[index].numRatings != 0) {
                        sub_rating =
                            (widget.cal_sub_names[index].totRatingsVal! /
                                ...
                                children: [
                                  ...
                                  TextButton(
                                      onPressed: () async {
                                        ...
                                        if (year_name == null ||
                                            !years_names.contains(year_name)) {
                                          Navigator.pop(context);
                                          ScaffoldMessenger.of(context)
                                              .showSnackBar(
                                            const SnackBar(
                                              ...
                                              content: Text(
                                                "year cant be null and value must between 2020 to 2023",
                                                style: TextStyle(
                                                    color: Colors.white),
                                              ),
                                            ),
