...
class all_lostwidget1 extends StatefulWidget {
  ...
  String domain;
  String email;
  all_lostwidget1(this.app_user, this.tag, this.category, this.lst_buy_list,
...
class _all_lostwidget1State extends State<all_lostwidget1> {
  ...
  void load_data_fun() async {
    List<Lost_Found> latest_lst_list = await lf_servers().get_lst_list(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.of(context)
              ...
              return lst_found_upload(widget.app_user, 'lost', 'belongings');
            }));
          },
          tooltip: 'wann share',
          child: Icon(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: FutureBuilder<List<LST_CMNT>>(
          future: lf_servers().get_lst_cmnt_list(widget.lst.id!),
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          //                             sending_cmnt = true;
          //                           });
          //                           List<dynamic> error = await lf_servers()
          //                               .post_lst_cmnt(
