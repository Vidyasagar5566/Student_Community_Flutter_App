...
class Buy_Sell {
  ...
  Buy_Sell.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
...
class BS_CMNT {
  ...
  BS_CMNT.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    lstId = json['bs_id'];
    comment = json['Comment'];
    postedDate = json['posted_date'];
    lstCmntId = json['bs_cmnt_id'];
    username = json['username'] != null
        ? new SmallUsername.fromJson(json['username'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['id'] = this.id;
    data['bs_id'] = this.lstId;
    data['Comment'] = this.comment;
    data['posted_date'] = this.postedDate;
    data['bs_cmnt_id'] = this.lstCmntId;
    if (this.username != null) {
      data['username'] = this.username!.toJson();
    }
    return data;
